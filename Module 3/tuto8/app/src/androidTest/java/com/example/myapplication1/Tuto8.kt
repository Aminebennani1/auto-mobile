...
import com.example.myapplication1.R // Assurez-vous d'importer correctement votre package
...
val sampleItems = listOf(
    ListItem("Tâche 1", R.drawable.images__6_),  // Remplacez par des icônes appropriées
    ListItem("Tâche 2", R.drawable.screenshot),
    ListItem("Tâche 3", R.drawable.androidparty)
)
